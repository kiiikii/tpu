...
?>
		...
		<!-- section hero -->
		<section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('assets/images/bonoloyo.jpg');" data-stellar-background-ratio="0.5">
