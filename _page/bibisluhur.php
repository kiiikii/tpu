...
?>
		...
		<!-- Section Hero -->
		<section class="hero-wrap hero-wrap-2 ftco-degree-bg js-fullheight" style="background-image: url('assets/images/astana-bibis-luhur.JPG');" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 ftco-animate">
						...
						<p><?= $row->alamat ?></p>
						<img src="assets/images/astana-bibis-luhur.JPG" alt="" class="img-fluid">
						<p><?= $row->deskripsi ?></p>
						<?php 
							}
					 	?>
